...
function analyzer(data, sidePass) {
          ...
          switch (item.intertype) {
            ...
            case 'mathop': {
              ...
              switch (value.op) {
                ...
                case 'bitcast': {
                  if (!sourceBits) {
                    // we can be asked to bitcast doubles or such to integers, handle that as best we can
  ...
  // Sign analyzer
  //
  // Analyze our variables and detect their signs.
