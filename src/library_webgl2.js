...
var LibraryWebGL2 = {
...
#if MEMORY64
      var pixelData = null;
      if (pixels) pixelData = emscriptenWebGLGetTexPixelData(type, format, width, height*depth, pixels, 0);
  ...
  glClearBufferuiv: (buffer, drawbuffer, value) => {
    ...
    GLctx.clearBufferuiv(buffer, drawbuffer, HEAP32, {{{ getHeapOffset('value', "u32") }}});
  },
...
#endif
    GLctx.uniform1uiv(webglGetUniformLocation(location), HEAPU32, {{{ getHeapOffset('value', 'u32') }}}, count);
  },
...
#endif
    GLctx.uniform2uiv(webglGetUniformLocation(location), HEAPU32, {{{ getHeapOffset('value', 'u32') }}}, count*2);
  },
...
#endif
    GLctx.uniform3uiv(webglGetUniformLocation(location), HEAPU32, {{{ getHeapOffset('value', 'u32') }}}, count*3);
  },
...
#endif
    GLctx.uniform4uiv(webglGetUniformLocation(location), HEAPU32, {{{ getHeapOffset('value', 'u32') }}}, count*4);
  },
...
#endif
    GLctx.uniformMatrix2x3fv(webglGetUniformLocation(location), !!transpose, HEAPF32, {{{ getHeapOffset('value', 'float') }}}, count*6);
  },
...
#endif
    GLctx.uniformMatrix3x2fv(webglGetUniformLocation(location), !!transpose, HEAPF32, {{{ getHeapOffset('value', 'float') }}}, count*6);
  },
...
#endif
    GLctx.uniformMatrix2x4fv(webglGetUniformLocation(location), !!transpose, HEAPF32, {{{ getHeapOffset('value', 'float') }}}, count*8);
  },
...
#endif
    GLctx.uniformMatrix4x2fv(webglGetUniformLocation(location), !!transpose, HEAPF32, {{{ getHeapOffset('value', 'float') }}}, count*8);
  },
...
#endif
    GLctx.uniformMatrix3x4fv(webglGetUniformLocation(location), !!transpose, HEAPF32, {{{ getHeapOffset('value', 'float') }}}, count*12);
  },
...
#endif
    GLctx.uniformMatrix4x3fv(webglGetUniformLocation(location), !!transpose, HEAPF32, {{{ getHeapOffset('value', 'float') }}}, count*12);
  },
  ...
  glDrawElementsInstancedBaseVertexBaseInstanceWEBGL__sig: 'viiipiii',
  ...
  glMultiDrawArraysInstancedBaseInstanceWEBGL__sig: 'viipppi',
  ...
  glMultiDrawElementsInstancedBaseVertexBaseInstanceWEBGL__sig: 'vipippppi',
