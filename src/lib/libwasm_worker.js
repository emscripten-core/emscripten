...
#error new Worker() supports ECMAScript module only starting from Firefox 114, Chrome 80 and Safari 15. Pass newer target -sMIN_*_VERSION fields to target -sEXPORT_ES6 with -sWASM_WORKERS. See https://caniuse.com/mdn-api_worker_worker_ecmascript_modules
#endif
  'type': 'module',
#endif
#if ENVIRONMENT_MAY_BE_NODE
