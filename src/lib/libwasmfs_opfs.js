...
addToLibrary({
  ...
  // so they must not be treated as asyncified/suspending imports (the proxying
  // queue is not entered through a promising export). The same applies to the
  // __async annotations below.
#if !PTHREADS
