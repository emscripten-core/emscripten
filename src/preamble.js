...
function ccall(ident, returnType, argTypes, args, opts) {
  ...
  assert((!opts || !opts.async) || Asyncify.asyncFinalizers.length === 0, 'Cannot have multiple async ccalls in flight at once');
#endif
  if (typeof Asyncify === 'object' && Asyncify.currData && Asyncify.asyncFinalizers.length === 0) {
