...
var EMBIND_STD_STRING_UTF8_SUPPORT = 0; //Embind specific: If enabled, support UTF-8 encoded data in std::string binding,
                                        //by default, UTF-8 is disabled to support binary data transfer
