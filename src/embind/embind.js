var LibraryEmbind = {
  ...
  $UnboundError__postset: "UnboundError = Module['UnboundError'] = extendError(Error, 'UnboundError');",
  $UnboundError__deps: ['$extendError'],
...
//    }
  ...
  _embind_register_enum__deps: ['$exposePublicSymbol', '$getShiftFromSize', '$integerReadValueFromPointer',
    '$readLatin1String', '$registerType'],
