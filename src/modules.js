...
var LIBRARY_FUNCS_TO_INCLUDE_SET = set(DEFAULT_LIBRARY_FUNCS_TO_INCLUDE.concat(EXTRA_LIBRARY_FUNCS_TO_INCLUDE));
DEFAULT_LIBRARY_FUNCS_TO_INCLUDE = unset(LIBRARY_FUNCS_TO_INCLUDE_SET);
EXTRA_LIBRARY_FUNCS_TO_INCLUDE = [];
