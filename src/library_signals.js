...
var funs = {
  signal: function(sig, func) {
    console.error('Calling stub instead of signal()');
    return 0;
  },
  ...
  sigaction: function(signum, act, oldact) {
    ...
    console.error('Calling stub instead of sigaction()');
    return 0;
  },
  sigprocmask: function() {
    console.error('Calling stub instead of sigprocmask()');
    return 0;
  },
  __libc_current_sigrtmin: function() {
    console.error('Calling stub instead of __libc_current_sigrtmin');
    return 0;
  },
  __libc_current_sigrtmax: function() {
    console.error('Calling stub instead of __libc_current_sigrtmax');
    return 0;
  },
  ...
  kill: function(pid, sig) {
    ...
    console.error('Calling stub instead of kill()');
  ...
  killpg: function() {
    console.error('Calling stub instead of killpg()');
    ___setErrNo(ERRNO_CODES.EPERM);
    return -1;
  },
  siginterrupt: function() {
    console.error('Calling stub instead of siginterrupt()');
    return 0;
  },

  raise__deps: ['$ERRNO_CODES', '__setErrNo'],
  raise: function(sig) {
    console.error('Calling stub instead of raise()');
  ...
  pause: function() {
    ...
    console.error('Calling stub instead of pause()');
