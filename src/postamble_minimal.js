...
(WebAssembly.instantiateStreaming
  ? WebAssembly.instantiateStreaming(fetch(Module['wasm'] || '{{{ TARGET_BASENAME }}}.wasm'), imports)
  : WebAssembly.instantiate(Module['wasm'], imports)).then(function(output) {
#else
WebAssembly.instantiateStreaming(fetch(Module['wasm'] || '{{{ TARGET_BASENAME }}}.wasm'), imports).then(function(output) {
#endif
