  ...
  $GL: {
    ...
    validateVertexAttribPointer: function(dimension, dataType, stride, offset) {
      ...
      switch(dataType) {
        ...
        default:
#if GL_MAX_FEATURE_LEVEL >= 20
          if (GL.currentContext.featureLevel >= 20 && (dataType == 0x8368 /* GL_UNSIGNED_INT_2_10_10_10_REV */ || dataType == 0x8D9F /* GL_INT_2_10_10_10_REV */)) {
            sizeBytes = 4;
            break;
          } else {
            // else fall through
    ...
    createContext: function(canvas, webGLContextAttributes) {
      ...
      context.supportsWebGL2EntryPoints = (context.featureLevel >= 20) && (getChromeVersion() === false || getChromeVersion() >= 58);
#endif
    ...
    lookupUniformTable: function(program, name) {
#if GL_ASSERTIONS
      GL.validateGLObjectID(GL.programs, program, 'lookupUniformTable', 'program');
#endif
      var arrayIndex = 0;
...
#endif
    return GL.lookupUniformTable(program, UTF8ToString(name));
  },
