...
var LibraryWebRTC = {
  $WebRTC: {
    Offer: function Offer(url, optMetadata, optExpires) {
      var offer = this;
      this.onpending = null;
    ...
    default_broker: "http://10.242.24.63:3000",
      ...
      var self = this;
      if (!broker)
        broker = WebRTC.default_broker;

      if (offer_id) {
        // Connecting to an offered connection.
        var answer = new WebRTC.Answer(broker + "/offer/" + offer_id);
        ...
        var offer = new WebRTC.Offer(broker);
