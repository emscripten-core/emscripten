...
(function() {
  ...
  if (currentNodeVersion < TARGET_NOT_SUPPORTED && {{{ MIN_NODE_VERSION }}} == TARGET_NOT_SUPPORTED) {
  ...
  if (currentSafariVersion < TARGET_NOT_SUPPORTED && {{{ MIN_SAFARI_VERSION }}} == TARGET_NOT_SUPPORTED) {
  ...
  if (currentFirefoxVersion < TARGET_NOT_SUPPORTED && {{{ MIN_FIREFOX_VERSION }}} == TARGET_NOT_SUPPORTED) {
  ...
  if (currentChromeVersion < TARGET_NOT_SUPPORTED && {{{ MIN_CHROME_VERSION }}} == TARGET_NOT_SUPPORTED) {
