...
(function() {
  ...
  if (currentNodeVersion < TARGET_NOT_SUPPORTED && 160000 == TARGET_NOT_SUPPORTED) {
  ...
  if (currentSafariVersion < TARGET_NOT_SUPPORTED && 150000 == TARGET_NOT_SUPPORTED) {
  ...
  if (currentChromeVersion < TARGET_NOT_SUPPORTED && 85 == TARGET_NOT_SUPPORTED) {
