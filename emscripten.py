...
def report_missing_symbols(all_implemented, pre):
  ...
  # Handle main specially, unless IGNORE_MISSING_MAIN or STANDALONE_WASM mode
  if not shared.Settings.STANDALONE_WASM and shared.Settings.EXPECT_MAIN and '_main' not in all_implemented and not shared.Settings.IGNORE_MISSING_MAIN:
