...
disabled = {
  **unsupported,
  ...
  'test_pthread_create_1_4': 'semaphores are not supported',
  ...
  'test_pthread_detach_1_2': 'semaphores are not supported',
  ...
  'test_pthread_mutex_init_3_2': 'semaphores are not supported',
  ...
  'test_pthread_mutex_lock_4_1': 'semaphores are not supported',
