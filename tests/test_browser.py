...
'''
  ...
  def test_zzz_zzz_4GB(self):
    self.btest(path_from_root('tests', 'browser', 'test_4GB.cpp'), '0',
               args=['-O2', '-s', 'ALLOW_MEMORY_GROWTH', '-s', 'MAXIMUM_MEMORY=4GB'])
  ...
  def test_zzz_zzz_2GB_fail(self):
    ...
    self.btest(path_from_root('tests', 'browser', 'test_2GB_fail.cpp'), '0',
               args=['-O2', '-s', 'ALLOW_MEMORY_GROWTH', '-s', 'MAXIMUM_MEMORY=2GB'])
  ...
  def test_zzz_zzz_4GB_fail(self):
    ...
    # 4GB.
    self.btest(path_from_root('tests', 'browser', 'test_4GB_fail.cpp'), '0',
               args=['-O2', '-s', 'ALLOW_MEMORY_GROWTH', '-s', 'MAXIMUM_MEMORY=4GB', '-s', 'ABORTING_MALLOC=0'])
