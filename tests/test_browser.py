...
#14 0x000000000036f799 lldMain(int, char const**, llvm::raw_ostream&, llvm::raw_ostream&, bool) lld.cpp:0:0''')
    self.btest(path_from_root('tests', 'wasm_worker', 'cpp11_thread_local.cpp'), expected='42', args=['-sWASM_WORKERS'])
...
#14 0x000000000036f799 lldMain(int, char const**, llvm::raw_ostream&, llvm::raw_ostream&, bool) lld.cpp:0:0''')
    ...
    self.btest(path_from_root('tests', 'wasm_worker', 'c11__Thread_local.c'), expected='42', args=['-sWASM_WORKERS', '-std=gnu11']) # Cannot test C11 - because of EM_ASM must test Gnu11.
...
#13 0x000000000065dd5e lld::wasm::link(llvm::ArrayRef<char const*>, llvm::raw_ostream&, llvm::raw_ostream&, bool, bool) (/root/emsdk/upstream/bin/wasm-ld+0x65dd5e)
#14 0x000000000036f799 lldMain(int, char const**, llvm::raw_ostream&, llvm::raw_ostream&, bool) lld.cpp:0:0''')
    self.btest(path_from_root('tests', 'wasm_worker', 'gcc___Thread.c'), expected='42', args=['-sWASM_WORKERS', '-std=gnu11'])
