...
html = '''<html><head></head><body><h1>SSE2 JavaScript Benchmark</h1>
...
for chart_name in charts_native.keys():
	...
	for result in native_results:
		...
		textual_results_native += 'Native SSE2 is ' + format_comparison(nsi, nsc) + ' than native scalar. &nbsp; &nbsp; &nbsp; &nbsp; <br />'
		...
		if html_result is not None:
			...
			textual_results_html += 'JS SSE2 is ' + format_comparison(hsi, hsc) + ' than JS scalar. &nbsp; &nbsp; &nbsp; &nbsp; <br />'
			textual_results_html2 += 'JS ' + result['category'] + ': JS scalar is ' + format_comparison(hsc, nsc) + ' than native scalar. &nbsp; &nbsp; &nbsp; &nbsp; <br />'
			textual_results_html3 += 'JS ' + result['category'] + ': JS SSE2 is ' + format_comparison(hsi, nsi) + ' than native SSE2. &nbsp; &nbsp; &nbsp; &nbsp; <br />'
