...
''', output)
      ...
      for params, test, text in [
        ...
        ([], lambda generated: ",'_dump'" not in generated, 'dump is not exported by default'),
        (['-s', 'EXPORTED_FUNCTIONS=["_main", "_dump"]'], lambda generated: ",'_dump'" in generated, 'dump is now exported'),
