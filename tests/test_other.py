...
''')
  ...
  def test_binaryen_metadce(self):
    ...
    test(path_from_root('tests', 'hello_world.cpp'), [
      ([],      24, ['abort', 'tempDoublePtr'], ['waka'],                  32705, 25, 20),
      (['-O1'], 19, ['abort', 'tempDoublePtr'], ['waka'],                   6364, 16, 18),
      (['-O2'], 19, ['abort', 'tempDoublePtr'], ['waka'],                   6325, 16, 18),
    ...
    open('minimal.c', 'w').write('''
      ...
      ''')
    test('minimal.c', [
      ([],      24, ['abort', 'tempDoublePtr'], ['waka'],                   8907, 25, 19),
      (['-O1'], 12, ['abort', 'tempDoublePtr'], ['waka'],                   4185,  9, 16),
      (['-O2'], 12, ['abort', 'tempDoublePtr'], ['waka'],                   4150,  9, 16),
