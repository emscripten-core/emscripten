...
#define FFMPEG_CONFIGURATION "--disable-asm --disable-programs --disable-debug --enable-cross-compile --cc=emcc --disable-runtime-cpudetect --disable-fast-unaligned --disable-hwaccels --disable-network --disable-stripping --disable-pthreads"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "emcc (Emscripten gcc/clang-like replacement) 1.38.40 ((unknown revision))"
