...
def wasm_bigint_min_browser_versions(user_settings):
  ...
  if "MIN_SAFARI_VERSION" in user_settings and user_settings["MIN_SAFARI_VERSION"] < 150000:
    exit_with_error("Cannot support Safari versions less than v15.0 when using the WASM_BIGINT setting")
