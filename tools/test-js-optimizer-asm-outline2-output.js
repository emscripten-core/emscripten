...
function _free($mem) {
 $mem = $mem | 0;
 var $3 = 0, $4 = 0, $5 = 0, $10 = 0, $11 = 0, $14 = 0, $15 = 0, $16 = 0, $21 = 0, $psize_0 = 0, $p_0 = 0, $189 = 0, $193 = 0, $194 = 0, sp = 0, helper$0 = 0;
 sp = STACKTOP;
 if (($mem | 0) == 0) {
  STACKTOP = sp;
  return;
 ...
 L621 : do {
  ...
  if (helper$0 ? ($10 & 1 | 0) == 0 : 0) {
   ...
   HEAP32[sp + 64 >> 2] = $15;
   HEAP32[sp + 360 >> 2] = $p_0;
   HEAP32[sp + 352 >> 2] = $psize_0;
   _free$1(sp);
   $p_0 = HEAP32[sp + 360 >> 2] | 0;
   $psize_0 = HEAP32[sp + 352 >> 2] | 0;
   tempValue = HEAP32[sp + 952 >> 2] | 0;
   tempInt = HEAP32[sp + 956 >> 2] | 0;
   tempDouble = +HEAPF32[sp + 956 >> 2];
   HEAP32[sp + 952 >> 2] = 0;
   HEAP32[sp + 956 >> 2] = 0;
   if ((tempValue | 0) == 5) {
    return;
 ...
 HEAP32[sp + 376 >> 2] = $193;
 _free$2(sp);
 tempValue = HEAP32[sp + 960 >> 2] | 0;
 tempInt = HEAP32[sp + 964 >> 2] | 0;
 tempDouble = +HEAPF32[sp + 964 >> 2];
 HEAP32[sp + 960 >> 2] = 0;
 HEAP32[sp + 964 >> 2] = 0;
 if ((tempValue | 0) == 5) {
  return;
...
function _free$0(sp) {
 sp = sp | 0;
 var $16 = 0, $204 = 0, $psize_0 = 0, $p_0 = 0, $220 = 0, $189 = 0, $227 = 0, $194 = 0, $228 = 0, helper$2 = 0, $233 = 0, $mem = 0, $14 = 0, $236 = 0, $239 = 0, $_pre_phi305 = 0, $262 = 0, $267 = 0, $15 = 0, $270 = 0, $273 = 0, $293 = 0, $294 = 0, $298 = 0, $299 = 0, $R7_1 = 0, $R7_0 = 0, $RP9_0 = 0, $301 = 0, $302 = 0, $305 = 0, $306 = 0, $278 = 0, $283 = 0, $287 = 0, $318 = 0, $320 = 0, $334 = 0, $351 = 0, $364 = 0, $psize_1 = 0;
 $psize_1 = HEAP32[sp + 640 >> 2] | 0;
 $15 = HEAP32[sp + 64 >> 2] | 0;
 $14 = HEAP32[sp + 56 >> 2] | 0;
 $mem = HEAP32[sp + 8 >> 2] | 0;
 $194 = HEAP32[sp + 384 >> 2] | 0;
 $189 = HEAP32[sp + 368 >> 2] | 0;
 $p_0 = HEAP32[sp + 360 >> 2] | 0;
 $psize_0 = HEAP32[sp + 352 >> 2] | 0;
 $16 = HEAP32[sp + 72 >> 2] | 0;
 OL : do {
 ...
 HEAP32[sp + 640 >> 2] = $psize_1;
}
function _free$1(sp) {
 sp = sp | 0;
 var $11 = 0, $_sum233 = 0, $21 = 0, $24 = 0, $mem = 0, $25 = 0, $26 = 0, $14 = 0, $5 = 0, $177 = 0, $15 = 0, $32 = 0, $37 = 0, $40 = 0, $43 = 0, $_pre_phi307 = 0, $64 = 0, $69 = 0, $72 = 0, $75 = 0, $94 = 0, $95 = 0, $99 = 0, $100 = 0, $R_1 = 0, $R_0 = 0, $RP_0 = 0, $102 = 0, $103 = 0, $106 = 0, $107 = 0, $80 = 0, $84 = 0, $88 = 0, $118 = 0, $120 = 0, $134 = 0, $151 = 0, $164 = 0, $p_0 = 0, $psize_0 = 0;
 $psize_0 = HEAP32[sp + 352 >> 2] | 0;
 $p_0 = HEAP32[sp + 360 >> 2] | 0;
 $15 = HEAP32[sp + 64 >> 2] | 0;
 $5 = HEAP32[sp + 32 >> 2] | 0;
...
function _free$2(sp) {
 sp = sp | 0;
 var helper$1 = 0, $194 = 0, $16 = 0, $psize_0 = 0, $p_0 = 0, $189 = 0, $mem = 0, $14 = 0, $15 = 0, $psize_1 = 0, $193 = 0, $390 = 0, $393 = 0, $395 = 0, $396 = 0, $397 = 0, $F16_0 = 0, $_pre_phi = 0, $403 = 0, $404 = 0, $414 = 0, $415 = 0, $I18_0 = 0, $422 = 0, $423 = 0, $426 = 0, $428 = 0, $431 = 0, $436 = 0, $443 = 0, $447 = 0, $448 = 0, $463 = 0, $K19_0 = 0, $T_0 = 0, $472 = 0, $473 = 0, label = 0, $486 = 0, $487 = 0, $489 = 0, $501 = 0, $sp_0_in_i = 0, $sp_0_i = 0;
 $193 = HEAP32[sp + 376 >> 2] | 0;
 $15 = HEAP32[sp + 64 >> 2] | 0;
 $14 = HEAP32[sp + 56 >> 2] | 0;
 $mem = HEAP32[sp + 8 >> 2] | 0;
 $189 = HEAP32[sp + 368 >> 2] | 0;
 ...
 OL : do {
  do {
   ...
   if (helper$1 ? ($194 & 2 | 0) == 0 : 0) {
    ...
    _free$0(sp);
    $psize_1 = HEAP32[sp + 640 >> 2] | 0;
    tempValue = HEAP32[sp + 944 >> 2] | 0;
    tempInt = HEAP32[sp + 948 >> 2] | 0;
    tempDouble = +HEAPF32[sp + 948 >> 2];
    HEAP32[sp + 944 >> 2] = 0;
    HEAP32[sp + 948 >> 2] = 0;
    if ((tempValue | 0) == 5) {
     HEAP32[sp + 960 >> 2] = 5;
