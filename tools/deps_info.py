...
def get_deps_info():
  ...
  if settings.USE_PTHREADS:
    _deps_info['emscripten_set_canvas_element_size_calling_thread'] = ['emscripten_dispatch_to_thread']
    _deps_info['emscripten_set_offscreencanvas_size_on_target_thread'] = ['emscripten_dispatch_to_thread', 'malloc', 'free']
  return _deps_info
