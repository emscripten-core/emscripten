...
function i32_8() {
 if (!(HEAP8[$4 & 16777215] | 0)) {
  print(5);
 }
 if (!(HEAP8[$5 & 16777215] | 0)) {
  print(5);
 }
 if (!(HEAP8[$6 & 16777215] | 0)) {
  print(5);
 }
 if (!(HEAP8[$7 & 16777215] | 0)) {
  print(5);
 }
 if (!(HEAPU8[$8 & 16777215] << 24 >> 16)) {
  print(5);
 }
 if (!(HEAPU8[$9 & 16777215] << 16 >> 16)) {
  print(5);
 }
}
function sign_extension_simplification() {
 if (!(HEAP8[$4 & 16777215] & 127)) {
  print(5);
 }
 if (!((HEAP8[$4 & 16777215] & 128) << 24 >> 24)) {
  print(5);
 }
 if (!(HEAP32[$5 & 16777215] & 32767)) {
  print(5);
 }
 if (!((HEAP32[$5 & 16777215] & 32768) << 16 >> 16)) {
  print(5);
 }
}
