...
//
//   var _foo = (a0, a1) => (_foo = Module['asm']['foo'])(a0, a1):
//
function isExportWrapperFunction(f) {
  ...
  const rhs = callee.right;
  if (rhs.object.type != 'MemberExpression' || !isModuleUse(rhs.object)) return null;
