...
def traverse_bcd(obj):
    ...
    for key, value in obj.items():
        if not key.startswith("__"):
            ...
            if not all(
                min_interesting_version >= out_value.get(browser, maxsize)
                for browser, min_interesting_version in min_interesting_versions.items()
            ):
                out["#"] = out_value
    return out
...
out["js"]["performance"] = {
    "#": {"chrome": 24, "firefox": 15, "nodejs": 160000, "safari": 80000}
}
