...
c_header = f'''/* Auto-generated by {os.path.basename(__file__)} */
...
cxx_header = f'''/* Auto-generated by {os.path.basename(__file__)} */
...
def write_sig_library(filename, sig_info):
  lines = [
    '/* Auto-generated by tools/maint/gen_sig_info.py. DO NOT EDIT. */',
    '',
    'sigs = {',
  ]
