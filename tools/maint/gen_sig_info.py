...
def write_sig_library(filename, sig_info):
  lines = ['/* Auto-generated by tools/gen_sig_info.py. DO NOT EDIT. */', '', 'sigs = {']
...
def extract_sig_info(sig_info, extra_settings=None, extra_cflags=None, cxx=False):
  ...
  with tempfiles.get_file('.json') as settings_json:
    ...
    output = shared.run_js_tool(
      utils.path_from_root('src/compiler.mjs'),
      ['--symbols-only', settings_json],
      stdout=subprocess.PIPE,
      cwd=utils.path_from_root(),
    )
...
def main(args):
  ...
  parser.add_argument(
    ...
    '--remove',
    action='store_true',
    help='remove from JS library files any `__sig` entries that are part of the auto-generated file',
  )
  parser.add_argument(
    '-u',
    '--update',
    action='store_true',
    help='update with JS library files any `__sig` entries that are part of the auto-generated file',
  )
  ...
  extract_sig_info(
    sig_info,
    {
      'JS_LIBRARIES': ['src/embind/embind.js', 'src/embind/emval.js'],
      'USE_SDL': 0,
      'MAX_WEBGL_VERSION': 0,
      'AUTO_JS_LIBRARIES': 0,
      'ASYNCIFY': 1,
