...
def ignore_symbol(s, cxx):
  ...
  if s in {'SDL_GetKeyState'}:
    return True
  # Symbols that start with emscripten_gl or emscripten_alc are auto-generated wrappers
  # around GL and OpenGL symbols.  Since they inherit their signature they don't need
  # to be auto-generated.
  if s.startswith('emscripten_gl') or s.startswith('emscripten_alc'):
    return True
  # Similar to above but generated by OFFSCREENCANVAS_SUPPORT.
