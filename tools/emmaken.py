 ...
 * For SCons emscripten can be set up like so (Tool has to be present in <SConstruct_directory>/site_cons/site_tools/emscripten/):
    env = Environment()
    # Import emscripten Tool for this Environment
    env.Tool("emscripten")
    
    env.Program("myprogram", src.c)
