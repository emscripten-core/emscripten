...
def setup_environment_settings():
  ...
  if settings.ENVIRONMENT and 'worklet' in settings.ENVIRONMENT and not settings.SINGLE_FILE:
    exit_with_error('targeting audio worklets directly currently requires -sSINGLE_FILE')
