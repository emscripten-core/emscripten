...
# built documents.
#
emscripten_version = Path(os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'emscripten-version.txt'))).read_text().strip().replace('"', '')
