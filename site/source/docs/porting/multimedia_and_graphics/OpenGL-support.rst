...
Another option is to use `gl4es <https://github.com/ptitSeb/gl4es>`_ wich aim at fast OpenGL to GLES conversion for games. It targets OpenGL 2.1 profile on top of OpenGL ES 2.0 and has been used to port a few games with Emscripten already.
