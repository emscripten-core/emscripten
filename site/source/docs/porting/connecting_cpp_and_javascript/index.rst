================================================
Connecting C++ and JavaScript (ready-for-review) 
================================================

Emscripten provides various options for connecting "normal" JavaScript and compiled code, which range from functions to call compiled C/C++ from JavaScript (and visa versa) through to accessing environment variables from compiled code. 
