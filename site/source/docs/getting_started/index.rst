...
We also explain where to :ref:`Report Bugs <bug-reports>` in the toolchain and the site, and how to use Emscripten with :ref:`Visual Studio 2010 <getting-started-emscripten-from-visual-studio>` (Windows only). 
