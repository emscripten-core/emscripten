...
.. note:: In this section, and later on, we run some files from the ``tests/``
...
<https://github.com/emscripten-core/emscripten/blob/main/tests/hello_world_sdl.cpp>`_
...
<https://github.com/emscripten-core/emscripten/blob/main/tests/hello_world_file.cpp>`_
