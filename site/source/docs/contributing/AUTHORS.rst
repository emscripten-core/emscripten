...
The `AUTHORS
<https://github.com/emscripten-core/emscripten/blob/incoming/AUTHORS>`_ file
lists everyone who has contributed to Emscripten.
...
The contributors for releases up to Emscripten |release| inclusive (|today|) are
listed below.
