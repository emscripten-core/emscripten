...
int _mmap_js(size_t length, int prot, int flags, int fd, size_t offset, int* allocated, void** addr);
int _msync_js(intptr_t addr, size_t length, int prot, int flags, int fd, size_t offset);
