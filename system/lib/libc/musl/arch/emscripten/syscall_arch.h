...
int __syscall_getrusage(int who, /* struct rusage *usage */void *usage);
...
pid_t __syscall_wait4(pid_t pid, int *wstatus, int options, /* struct rusage *rusage */void *rusage);
...
int __syscall__newselect(int nfds, fd_set *readfds, fd_set *writefds, fd_set *exceptfds, /* struct timeval *timeout */long timeout[2]);
...
int __syscall_getdents64(int fd, /* struct dirent *dirp */void *dirp, size_t count);
...
int __syscall_pselect6(int nfds, fd_set *rfds, fd_set *wfds, fd_set *efds, const /* struct timespec *ts */long ts[2], const void *mask);
