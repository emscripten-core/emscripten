...
long __syscall19(int which, ...);
long __syscall20(int which, ...);
long __syscall26(int which, ...);
...
long __syscall78(int which, ...);
long __syscall83(int which, ...);
long __syscall85(int which, ...);
long __syscall86(int which, ...);
long __syscall91(int which, ...);
long __syscall93(int which, ...);
