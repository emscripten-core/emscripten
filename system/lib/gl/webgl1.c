...
void glBufferData(GLenum target, GLsizeiptr size, const void *data, GLenum usage)
{
  ...
  else
  {
    if (size < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIIII, &emscripten_glBufferData, ptr, target, size, ptr, usage);
        return;
      }
...
void glBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const void *data)
{
  ...
  else
  {
    if (size < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr || !data)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIIII, &emscripten_glBufferSubData, ptr, target, offset, size, ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void *pixels)
{
  ...
  else
  {
    ...
    if (!pixels || (sz >= 0 && sz < 256*1024)) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr || !pixels)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIIIIIIIII, &emscripten_glTexImage2D, ptr, target, level, internalformat, width, height, border, format, type, ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels)
{
  ...
  else
  {
    ...
    if (!pixels || (sz >= 0 && sz < 256*1024)) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr || !pixels)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIIIIIIIII, &emscripten_glTexSubImage2D, ptr, target, level, xoffset, yoffset, width, height, format, type, ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform1fv(GLint location, GLsizei count, const GLfloat *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform1fv, ptr, location, count, (GLfloat*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform1iv(GLint location, GLsizei count, const GLint *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform1iv, ptr, location, count, (GLint*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform2fv(GLint location, GLsizei count, const GLfloat *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform2fv, ptr, location, count, (GLfloat*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform2iv(GLint location, GLsizei count, const GLint *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform2iv, ptr, location, count, (GLint*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform3fv(GLint location, GLsizei count, const GLfloat *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform3fv, ptr, location, count, (GLfloat*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform3iv(GLint location, GLsizei count, const GLint *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform3iv, ptr, location, count, (GLint*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform4fv(GLint location, GLsizei count, const GLfloat *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform4fv, ptr, location, count, (GLfloat*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniform4iv(GLint location, GLsizei count, const GLint *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIII, &emscripten_glUniform4iv, ptr, location, count, (GLint*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniformMatrix2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIIII, &emscripten_glUniformMatrix2fv, ptr, location, count, transpose, (GLfloat*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIIII, &emscripten_glUniformMatrix3fv, ptr, location, count, transpose, (GLfloat*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
...
void glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
  ...
  else
  {
    ...
    if (sz < 256*1024) // run small buffer sizes asynchronously by copying - large buffers run synchronously
    {
      ...
      if (ptr)
      {
        emscripten_call_on_thread_maybe_async(*(void**)(pthread_getspecific(currentActiveWebGLContext) + 4), EM_FUNC_SIG_VIIII, &emscripten_glUniformMatrix4fv, ptr, location, count, transpose, (GLfloat*)ptr);
        return;
      }
      // Fall through on allocation failure and run synchronously.
    }
