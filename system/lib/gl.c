...
void* emscripten_GetProcAddress(const char *name_) {
  ...
  /*
    for line in open('a').readlines():
      ...
      line = line.replace(' * ', ' ').replace('const ', '')
  ...
  */
  ...
  if (!strcmp(name, "glColorTableParameterivGLenum")) return emscripten_glColorTableParameterivGLenum;
  if (!strcmp(name, "glColorTableParameterfvGLenum")) return emscripten_glColorTableParameterfvGLenum;
  ...
  if (!strcmp(name, "glActiveTextureGLenum")) return emscripten_glActiveTextureARBGLenum;
  if (!strcmp(name, "glClientActiveTextureGLenum")) return emscripten_glClientActiveTextureARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1dGLenum")) return emscripten_glMultiTexCoord1dARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1dvGLenum")) return emscripten_glMultiTexCoord1dvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1fGLenum")) return emscripten_glMultiTexCoord1fARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1fvGLenum")) return emscripten_glMultiTexCoord1fvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1iGLenum")) return emscripten_glMultiTexCoord1iARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1ivGLenum")) return emscripten_glMultiTexCoord1ivARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1sGLenum")) return emscripten_glMultiTexCoord1sARBGLenum;
  if (!strcmp(name, "glMultiTexCoord1svGLenum")) return emscripten_glMultiTexCoord1svARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2dGLenum")) return emscripten_glMultiTexCoord2dARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2dvGLenum")) return emscripten_glMultiTexCoord2dvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2fGLenum")) return emscripten_glMultiTexCoord2fARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2fvGLenum")) return emscripten_glMultiTexCoord2fvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2iGLenum")) return emscripten_glMultiTexCoord2iARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2ivGLenum")) return emscripten_glMultiTexCoord2ivARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2sGLenum")) return emscripten_glMultiTexCoord2sARBGLenum;
  if (!strcmp(name, "glMultiTexCoord2svGLenum")) return emscripten_glMultiTexCoord2svARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3dGLenum")) return emscripten_glMultiTexCoord3dARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3dvGLenum")) return emscripten_glMultiTexCoord3dvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3fGLenum")) return emscripten_glMultiTexCoord3fARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3fvGLenum")) return emscripten_glMultiTexCoord3fvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3iGLenum")) return emscripten_glMultiTexCoord3iARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3ivGLenum")) return emscripten_glMultiTexCoord3ivARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3sGLenum")) return emscripten_glMultiTexCoord3sARBGLenum;
  if (!strcmp(name, "glMultiTexCoord3svGLenum")) return emscripten_glMultiTexCoord3svARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4dGLenum")) return emscripten_glMultiTexCoord4dARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4dvGLenum")) return emscripten_glMultiTexCoord4dvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4fGLenum")) return emscripten_glMultiTexCoord4fARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4fvGLenum")) return emscripten_glMultiTexCoord4fvARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4iGLenum")) return emscripten_glMultiTexCoord4iARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4ivGLenum")) return emscripten_glMultiTexCoord4ivARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4sGLenum")) return emscripten_glMultiTexCoord4sARBGLenum;
  if (!strcmp(name, "glMultiTexCoord4svGLenum")) return emscripten_glMultiTexCoord4svARBGLenum;
  if (!strcmp(name, "glBlendColor")) return emscripten_glBlendColor;
  if (!strcmp(name, "glBlendEquation")) return emscripten_glBlendEquation;
  if (!strcmp(name, "glDrawRangeElements")) return emscripten_glDrawRangeElements;
  if (!strcmp(name, "glTexImage3D")) return emscripten_glTexImage3D;
  ...
  if (!strcmp(name, "glVertexAttribDivisor")) return emscripten_glVertexAttribDivisor;  return 0;
}
