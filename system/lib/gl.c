...
GLAPI const GLubyte * APIENTRY emscripten_glGetStringi (GLenum name, GLuint index);
...
void* emscripten_GetProcAddress(const char *name_) {
  ...
  else if (!strcmp(name, "glBindBufferBase")) return emscripten_glBindBufferBase;
  else if (!strcmp(name, "glBindBufferRange")) return emscripten_glBindBufferRange;
  ...
  else if (!strcmp(name, "glBindSampler")) return emscripten_glBindSampler;
  else if (!strcmp(name, "glBindTexture")) return emscripten_glBindTexture;
  else if (!strcmp(name, "glBindTransformFeedback")) return emscripten_glBindTransformFeedback;
  ...
  else if (!strcmp(name, "glBlitFramebuffer")) return emscripten_glBlitFramebuffer;
  ...
  else if (!strcmp(name, "glClearBufferfi")) return emscripten_glClearBufferfi;
  else if (!strcmp(name, "glClearBufferfv")) return emscripten_glClearBufferfv;
  else if (!strcmp(name, "glClearBufferiv")) return emscripten_glClearBufferiv;
  else if (!strcmp(name, "glClearBufferuiv")) return emscripten_glClearBufferuiv;
  ...
  else if (!strcmp(name, "glClientWaitSync")) return emscripten_glClientWaitSync;
  ...
  else if (!strcmp(name, "glCompressedTexImage3D")) return emscripten_glCompressedTexImage3D;
  else if (!strcmp(name, "glCompressedTexSubImage2D")) return emscripten_glCompressedTexSubImage2D;
  else if (!strcmp(name, "glCompressedTexSubImage3D")) return emscripten_glCompressedTexSubImage3D;
  else if (!strcmp(name, "glCopyBufferSubData")) return emscripten_glCopyBufferSubData;
  ...
  else if (!strcmp(name, "glCopyTexSubImage3D")) return emscripten_glCopyTexSubImage3D;
  ...
  else if (!strcmp(name, "glDeleteQueries")) return emscripten_glDeleteQueries;
  else if (!strcmp(name, "glDeleteRenderbuffers")) return emscripten_glDeleteRenderbuffers;
  else if (!strcmp(name, "glDeleteSamplers")) return emscripten_glDeleteSamplers;
  else if (!strcmp(name, "glDeleteShader")) return emscripten_glDeleteShader;
  else if (!strcmp(name, "glDeleteSync")) return emscripten_glDeleteSync;
  else if (!strcmp(name, "glDeleteTextures")) return emscripten_glDeleteTextures;
  else if (!strcmp(name, "glDeleteTransformFeedbacks")) return emscripten_glDeleteTransformFeedbacks;
  ...
  else if (!strcmp(name, "glEndQuery")) return emscripten_glEndQuery;
  else if (!strcmp(name, "glEndTransformFeedback")) return emscripten_glEndTransformFeedback;
  else if (!strcmp(name, "glFenceSync")) return emscripten_glFenceSync;
  else if (!strcmp(name, "glFinish")) return emscripten_glFinish;
  else if (!strcmp(name, "glFlush")) return emscripten_glFlush;
  else if (!strcmp(name, "glFlushMappedBufferRange")) return emscripten_glFlushMappedBufferRange;
  ...
  else if (!strcmp(name, "glFramebufferTextureLayer")) return emscripten_glFramebufferTextureLayer;
  ...
  else if (!strcmp(name, "glGenQueries")) return emscripten_glGenQueries;
  else if (!strcmp(name, "glGenRenderbuffers")) return emscripten_glGenRenderbuffers;
  else if (!strcmp(name, "glGenSamplers")) return emscripten_glGenSamplers;
  else if (!strcmp(name, "glGenTextures")) return emscripten_glGenTextures;
  else if (!strcmp(name, "glGenTransformFeedbacks")) return emscripten_glGenTransformFeedbacks;
  ...
  else if (!strcmp(name, "glGetActiveUniformBlockiv")) return emscripten_glGetActiveUniformBlockiv;
  else if (!strcmp(name, "glGetActiveUniformBlockName")) return emscripten_glGetActiveUniformBlockName;
  else if (!strcmp(name, "glGetActiveUniformsiv")) return emscripten_glGetActiveUniformsiv;
  ...
  else if (!strcmp(name, "glGetBufferParameteri64v")) return emscripten_glGetBufferParameteri64v;
  else if (!strcmp(name, "glGetBufferParameteriv")) return emscripten_glGetBufferParameteriv;
  else if (!strcmp(name, "glGetBufferPointerv")) return emscripten_glGetBufferPointerv;
  else if (!strcmp(name, "glGetError")) return emscripten_glGetError;
  else if (!strcmp(name, "glGetFloatv")) return emscripten_glGetFloatv;
  else if (!strcmp(name, "glGetFragDataLocation")) return emscripten_glGetFragDataLocation;
  else if (!strcmp(name, "glGetFramebufferAttachmentParameteriv")) return emscripten_glGetFramebufferAttachmentParameteriv;
  else if (!strcmp(name, "glGetInteger64i_v")) return emscripten_glGetInteger64i_v;
  else if (!strcmp(name, "glGetInteger64v")) return emscripten_glGetInteger64v;
  else if (!strcmp(name, "glGetIntegeri_v")) return emscripten_glGetIntegeri_v;
  else if (!strcmp(name, "glGetIntegerv")) return emscripten_glGetIntegerv;
  else if (!strcmp(name, "glGetInternalformativ")) return emscripten_glGetInternalformativ;
  else if (!strcmp(name, "glGetProgramBinary")) return emscripten_glGetProgramBinary;
  ...
  else if (!strcmp(name, "glGetQueryiv")) return emscripten_glGetQueryiv;
  else if (!strcmp(name, "glGetQueryObjectuiv")) return emscripten_glGetQueryObjectuiv;
  else if (!strcmp(name, "glGetRenderbufferParameteriv")) return emscripten_glGetRenderbufferParameteriv;
  else if (!strcmp(name, "glGetSamplerParameterfv")) return emscripten_glGetSamplerParameterfv;
  else if (!strcmp(name, "glGetSamplerParameteriv")) return emscripten_glGetSamplerParameteriv;
  ...
  else if (!strcmp(name, "glGetSynciv")) return emscripten_glGetSynciv;
  ...
  else if (!strcmp(name, "glGetTransformFeedbackVarying")) return emscripten_glGetTransformFeedbackVarying;
  else if (!strcmp(name, "glGetUniformBlockIndex")) return emscripten_glGetUniformBlockIndex;
  else if (!strcmp(name, "glGetUniformfv")) return emscripten_glGetUniformfv;
  else if (!strcmp(name, "glGetUniformIndices")) return emscripten_glGetUniformIndices;
  ...
  else if (!strcmp(name, "glGetUniformuiv")) return emscripten_glGetUniformuiv;
  else if (!strcmp(name, "glGetVertexAttribfv")) return emscripten_glGetVertexAttribfv;
  else if (!strcmp(name, "glGetVertexAttribIiv")) return emscripten_glGetVertexAttribIiv;
  else if (!strcmp(name, "glGetVertexAttribIuiv")) return emscripten_glGetVertexAttribIuiv;
  ...
  else if (!strcmp(name, "glInvalidateFramebuffer")) return emscripten_glInvalidateFramebuffer;
  else if (!strcmp(name, "glInvalidateSubFramebuffer")) return emscripten_glInvalidateSubFramebuffer;
  ...
  else if (!strcmp(name, "glIsQuery")) return emscripten_glIsQuery;
  else if (!strcmp(name, "glIsRenderbuffer")) return emscripten_glIsRenderbuffer;
  else if (!strcmp(name, "glIsSampler")) return emscripten_glIsSampler;
  else if (!strcmp(name, "glIsShader")) return emscripten_glIsShader;
  else if (!strcmp(name, "glIsSync")) return emscripten_glIsSync;
  else if (!strcmp(name, "glIsTexture")) return emscripten_glIsTexture;
  else if (!strcmp(name, "glIsTransformFeedback")) return emscripten_glIsTransformFeedback;
  ...
  else if (!strcmp(name, "glMapBufferRange")) return emscripten_glMapBufferRange;
  else if (!strcmp(name, "glPauseTransformFeedback")) return emscripten_glPauseTransformFeedback;
  else if (!strcmp(name, "glPixelStorei")) return emscripten_glPixelStorei;
  else if (!strcmp(name, "glPolygonOffset")) return emscripten_glPolygonOffset;
  else if (!strcmp(name, "glProgramBinary")) return emscripten_glProgramBinary;
  else if (!strcmp(name, "glProgramParameteri")) return emscripten_glProgramParameteri;
  else if (!strcmp(name, "glReadBuffer")) return emscripten_glReadBuffer;
  ...
  else if (!strcmp(name, "glRenderbufferStorageMultisample")) return emscripten_glRenderbufferStorageMultisample;
  else if (!strcmp(name, "glResumeTransformFeedback")) return emscripten_glResumeTransformFeedback;
  else if (!strcmp(name, "glSampleCoverage")) return emscripten_glSampleCoverage;
  else if (!strcmp(name, "glSamplerParameterf")) return emscripten_glSamplerParameterf;
  else if (!strcmp(name, "glSamplerParameterfv")) return emscripten_glSamplerParameterfv;
  else if (!strcmp(name, "glSamplerParameteri")) return emscripten_glSamplerParameteri;
  else if (!strcmp(name, "glSamplerParameteriv")) return emscripten_glSamplerParameteriv;
  ...
  else if (!strcmp(name, "glTransformFeedbackVaryings")) return emscripten_glTransformFeedbackVaryings;
  ...
  else if (!strcmp(name, "glUniform1ui")) return emscripten_glUniform1ui;
  else if (!strcmp(name, "glUniform1uiv")) return emscripten_glUniform1uiv;
  ...
  else if (!strcmp(name, "glUniform2ui")) return emscripten_glUniform2ui;
  else if (!strcmp(name, "glUniform2uiv")) return emscripten_glUniform2uiv;
  ...
  else if (!strcmp(name, "glUniform3ui")) return emscripten_glUniform3ui;
  else if (!strcmp(name, "glUniform3uiv")) return emscripten_glUniform3uiv;
  ...
  else if (!strcmp(name, "glUniform4ui")) return emscripten_glUniform4ui;
  else if (!strcmp(name, "glUniform4uiv")) return emscripten_glUniform4uiv;
  else if (!strcmp(name, "glUniformBlockBinding")) return emscripten_glUniformBlockBinding;
  else if (!strcmp(name, "glUniformMatrix2fv")) return emscripten_glUniformMatrix2fv;
  else if (!strcmp(name, "glUniformMatrix2x3fv")) return emscripten_glUniformMatrix2x3fv;
  else if (!strcmp(name, "glUniformMatrix2x4fv")) return emscripten_glUniformMatrix2x4fv;
  else if (!strcmp(name, "glUniformMatrix3fv")) return emscripten_glUniformMatrix3fv;
  else if (!strcmp(name, "glUniformMatrix3x2fv")) return emscripten_glUniformMatrix3x2fv;
  else if (!strcmp(name, "glUniformMatrix3x4fv")) return emscripten_glUniformMatrix3x4fv;
  else if (!strcmp(name, "glUniformMatrix4fv")) return emscripten_glUniformMatrix4fv;
  else if (!strcmp(name, "glUniformMatrix4x2fv")) return emscripten_glUniformMatrix4x2fv;
  else if (!strcmp(name, "glUniformMatrix4x3fv")) return emscripten_glUniformMatrix4x3fv;
  else if (!strcmp(name, "glUnmapBuffer")) return emscripten_glUnmapBuffer;
  ...
  else if (!strcmp(name, "glVertexAttribI4i")) return emscripten_glVertexAttribI4i;
  else if (!strcmp(name, "glVertexAttribI4iv")) return emscripten_glVertexAttribI4iv;
  else if (!strcmp(name, "glVertexAttribI4ui")) return emscripten_glVertexAttribI4ui;
  else if (!strcmp(name, "glVertexAttribI4uiv")) return emscripten_glVertexAttribI4uiv;
  ...
  else if (!strcmp(name, "glWaitSync")) return emscripten_glWaitSync;
