...
{
  return wasm_f32x4_make(__w, __x, __y, __z);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_setr_ps(float __z, float __y, float __x, float __w)
{
  return wasm_f32x4_make(__z, __y, __x, __w);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_set_ss(float __w)
{
  return wasm_f32x4_make(__w, 0, 0, 0);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_set_ps1(float __w)
{
  return wasm_f32x4_splat(__w);
}
...
{
  return __builtin_shufflevector(wasm_f32x4_make(((float*)__p)[0], ((float*)__p)[1], 0.f, 0.f), __a, 0, 1, 6, 7);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_loadh_pi(__m128 __a, const void /*__m64*/ *__p)
{
  return __builtin_shufflevector(__a, wasm_f32x4_make(((float*)__p)[0], ((float*)__p)[1], 0.f, 0.f), 0, 1, 4, 5);
}
...
{
  return wasm_v128_load(__p);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_load_ps1(const float *__p)
{
  return wasm_v32x4_load_splat(__p);
}
...
{
  return wasm_f32x4_make(*__p, 0.f, 0.f, 0.f);
}
...
{
  *__p = (__m64)__builtin_shufflevector(__a, __a, 6, 7, 2, 3); // _mm_movehl_ps pattern
}
...
{
//  return wasm_f32x4_pmin(__a, __b); // TODO: Migrate to this, once it works in VMs
  return wasm_v128_bitselect(__a, __b, wasm_f32x4_lt(__a, __b));
}
...
{
//  return wasm_f32x4_pmax(__a, __b); // TODO: Migrate to this, once it works in VMs
  return wasm_v128_bitselect(__a, __b, wasm_f32x4_gt(__a, __b));
}
...
{
    return wasm_f32x4_div(_mm_set1_ps(1.0f), __a);
}
...
{
  return wasm_v128_and(wasm_f32x4_eq(__a, __a),
                       wasm_f32x4_eq(__b, __b));
}
...
{
  return wasm_v128_or(wasm_f32x4_ne(__a, __a),
                      wasm_f32x4_ne(__b, __b));
}
...
{
  return wasm_v128_and(__a, __b);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_andnot_ps(__m128 __a, __m128 __b)
{
  return wasm_v128_andnot(__b, __a);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_or_ps(__m128 __a, __m128 __b)
{
  return wasm_v128_or(__a, __b);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_xor_ps(__m128 __a, __m128 __b)
{
  return wasm_v128_xor(__a, __b);
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_cmpneq_ps(__m128 __a, __m128 __b)
{
  return wasm_f32x4_ne(__a, __b);
}
...
{
  return wasm_v128_not(_mm_cmpge_ps(__a, __b));
}
...
{
  return wasm_v128_not(_mm_cmpgt_ps(__a, __b));
}
...
{
  return wasm_v128_not(_mm_cmple_ps(__a, __b));
}
...
{
  return wasm_v128_not(_mm_cmplt_ps(__a, __b));
}
...
static __inline__ int __attribute__((__always_inline__)) _mm_getcsr()
{
