...
{
  return (__m128)__builtin_shufflevector((__f32x4)__a, (__f32x4)__a, 1, 1, 3, 3);
}

static __inline__ __m128 __attribute__((__always_inline__, __nodebug__))
_mm_moveldup_ps(__m128 __a)
{
  return (__m128)__builtin_shufflevector((__f32x4)__a, (__f32x4)__a, 0, 0, 2, 2);
}
...
{
  return (__m128d)__builtin_shufflevector((__f64x2)__a, (__f64x2)__a, 0, 0);
}
