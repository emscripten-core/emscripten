 ...
 */
extern EMSCRIPTEN_RESULT emscripten_set_resize_callback(void *userData, int useCapture, EM_BOOL (*func)(int eventType, const EmscriptenUiEvent *uiEvent, void *userData));
