...
extern EMSCRIPTEN_RESULT emscripten_webgl_create_context_ptr(const char *target, const EmscriptenWebGLContextAttributes *attributes, EMSCRIPTEN_WEBGL_CONTEXT_HANDLE *outHandle);
